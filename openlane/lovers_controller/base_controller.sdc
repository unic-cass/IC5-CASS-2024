...
set_input_delay -max 1.87 -clock [get_clocks {clk}] [get_ports {next_key}]
set_input_delay -max 1.87 -clock [get_clocks {clk}] [get_ports {becStatus[*]}]
set_input_delay -max 1.87 -clock [get_clocks {clk}] [get_ports {slv_done}]
...
set_input_delay -min 0.18 -clock [get_clocks {clk}] [get_ports {next_key}]
set_input_delay -min 0.18 -clock [get_clocks {clk}] [get_ports {becStatus[*]}]
set_input_delay -min 0.18 -clock [get_clocks {clk}] [get_ports {slv_done}]
...
set_input_transition -max 0.14  [get_ports {next_key}]
set_input_transition -max 0.14  [get_ports {becStatus[*]}]
set_input_transition -max 0.14  [get_ports {slv_done}]
...
set_input_transition -min 0.05  [get_ports {next_key}]
set_input_transition -min 0.05  [get_ports {becStatus[*]}]
set_input_transition -min 0.05  [get_ports {slv_done}]
set_input_transition -min 0.05  [get_ports {data_in[*]}]
...
set_output_delay -max 1.0  -clock [get_clocks {clk}] [get_ports {master_ena_proc}]
set_output_delay -max 1.0  -clock [get_clocks {clk}] [get_ports {load_data}]
set_output_delay -max 1.0  -clock [get_clocks {clk}] [get_ports {load_status[*]}]
set_output_delay -max 1.0  -clock [get_clocks {clk}] [get_ports {data_out[*]}]
set_output_delay -max 1.0  -clock [get_clocks {clk}] [get_ports {trigLoad}]
set_output_delay -max 1.0  -clock [get_clocks {clk}] [get_ports {ki}]
...
set_output_delay -min 0  -clock [get_clocks {clk}] [get_ports {master_ena_proc}]
set_output_delay -min 0  -clock [get_clocks {clk}] [get_ports {load_data}]
set_output_delay -min 0  -clock [get_clocks {clk}] [get_ports {load_status[*]}]
set_output_delay -min 0  -clock [get_clocks {clk}] [get_ports {data_out[*]}]
set_output_delay -min 0  -clock [get_clocks {clk}] [get_ports {trigLoad}]
set_output_delay -min 0  -clock [get_clocks {clk}] [get_ports {ki}]
