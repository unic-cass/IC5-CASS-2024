...
# Input Transition
set_input_transition -max 0.14  [get_ports {la_data_in[*]}]
...
set_input_transition -min 0.06  [get_ports {next_key}]
set_input_transition -min 0.07  [get_ports {becStatus[*]}]
set_input_transition -min 0.07  [get_ports {data_in[*]}]
set_input_transition -min 0.07  [get_ports {slv_done}]

# Output delays
set_output_delay -max 0.7 -clock [get_clocks {clk}] [get_ports {la_data_out[*]}]
set_output_delay -max 0.7 -clock [get_clocks {clk}] [get_ports {slv_enable}]
set_output_delay -max 0.7 -clock [get_clocks {clk}] [get_ports {load_data}]
set_output_delay -max 0.7 -clock [get_clocks {clk}] [get_ports {load_status[*]}]
set_output_delay -max 0.7 -clock [get_clocks {clk}] [get_ports {data_out[*]}]
set_output_delay -max 0.7 -clock [get_clocks {clk}] [get_ports {ki}]


set_output_delay -min 0 -clock [get_clocks {clk}] [get_ports {la_data_out[*]}]
set_output_delay -min 0 -clock [get_clocks {clk}] [get_ports {slv_enable}]
