...
# }
set_input_delay -max 3.17 -clock [get_clocks {clk}] [get_ports {phase_in}]
set_output_delay -max 3.62 -clock [get_clocks {clk}] [get_ports {vco_enb_o}]
set_input_transition -max 0.84  [get_ports {phase_in}]
# Output loads
