...
# Input delays
set_input_delay -max 1.87 -clock [get_clocks {clk}] [get_ports {enable}]
...
# Input Transition
set_input_transition -max 0.14  [get_ports {enable}]
...
# Output delays
set_output_delay -max 0.7 -clock [get_clocks {clk}] [get_ports {next_key}]
set_output_delay -max 0.7 -clock [get_clocks {clk}] [get_ports {becStatus[*]}]
...
set_output_delay -min 0 -clock [get_clocks {clk}] [get_ports {next_key}]
set_output_delay -min 0 -clock [get_clocks {clk}] [get_ports {becStatus[*]}]
